...
const Variants: Record<ButtonVariant, string> = {
  ...
  [ButtonVariant.ghost]: 'bg-transparent hover:dark:bg-slate-900 hover:bg-slate-100 dark:text-white text-black',
...
const ActiveVariant: Record<ButtonVariant, string> = {
  ...
  [ButtonVariant.tertiary]: 'bg-slate-200 hover:bg-slate-200 dark:bg-slate-800 hover:dark:bg-slate-800',
...
const InvertVariants: Record<ButtonVariant, string> = {
  ...
  [ButtonVariant.ghost]: 'bg-transparent hover:dark:bg-slate-900 hover:bg-slate-200 dark:text-white text-black',
...
export const Button = ({
  ...
  /* Render JSX */
  return <Root className={classes.button} type={htmlType} disabled={isDisabled} onClick={onClick} {...restOfProps} />;
};
